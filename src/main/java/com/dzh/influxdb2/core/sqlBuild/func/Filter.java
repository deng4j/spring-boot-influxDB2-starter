...
import com.dzh.influxdb2.core.common.enums.SqlKeyword;
import com.dzh.influxdb2.core.common.domain.express.Entity;
import com.dzh.influxdb2.core.common.domain.express.Express;
import com.dzh.influxdb2.core.common.domain.express.Logic;
...
public class Filter<T> implements Compare<T, Filter<T>> {
    ...
    private void addEntity(SFunction<T> sf, SqlKeyword keyword, Object value) {
        ...
        expressList.add(new Entity(fieldName, keyword.getSql(), StringUtils.addDoubleQuotes(value.toString())));
    ...
    public String getSql() {
        ...
        for (int i = 0; i < expressList.size() - 1; i++) {
            ...
            if (express instanceof Entity) {
                ...
                e.setFiedName("r." + Identifier.COLUMN + e.getFiedName());
            }
